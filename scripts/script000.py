...
def carregar_dados_totais(anos = [2018, 2019, 2022, 2023], prefixoLeitura="../dados/originais/MICRODADOS_ENEM_"):
...
def carregar_dados_ita(anos = [2018, 2019, 2022, 2023], prefixoLeitura = '../dados/MD_ENEM_ITA_'):
...
def salvar_dados_ita(anos = [2018, 2019, 2022, 2023], prefixoEscrita = '../dados/MD_ENEM_ITA_'):
